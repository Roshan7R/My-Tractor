...
class AppTheme {
  ...
  static ThemeData darkTheme = ThemeData(
      ...
      tabBarTheme: TabBarThemeData(labelColor: primaryDark, unselectedLabelColor: textSecondaryDark, indicatorColor: primaryDark, indicatorSize: TabBarIndicatorSize.tab, labelStyle: GoogleFonts.roboto(fontSize: 16, fontWeight: FontWeight.w500), unselectedLabelStyle: GoogleFonts.roboto(fontSize: 16, fontWeight: FontWeight.w400)),
